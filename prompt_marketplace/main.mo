...
actor class PromptMarketplace(ledger_id : Principal) = this {
  ...
  public shared ({ caller }) func update_item(
    ...
    items.updateItem(caller, itemId, title, description, contentHash, price, itemType, category, licenseTerms, thumbnailImages, contentFileKey, contentFileName, contentRetrievalUrl);
  };
